    ...
    <div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16">
        ...
        <div className="mb-8 flex flex-col items-center justify-between md:flex-row">
          <h1 className="mb-4 text-3xl font-bold md:mb-0">Our Products</h1>
          <div className="flex w-full gap-4 md:w-auto">
            <button
              onClick={() => handleViewModeChange("grid")}
              className="hidden h-10 w-10 items-center justify-center rounded-md border transition-colors duration-300 ease-in-out hover:bg-gray-100 hover:text-black md:flex"
                ...
                <div
                  className={
                    viewMode === "grid"
                      ...
                      : "flex flex-col gap-8 md:flex-col"
                  }
                >
